...
import 'package:login/Pages/ViewEmail.dart';
class SentBox extends StatefulWidget {
  const SentBox({ Key key }) : super(key: key);

  @override
  _SentBoxState createState() => _SentBoxState();
}
FirebaseAuth _auth =FirebaseAuth.instance;

String email = _auth.currentUser.email.toString();
class _SentBoxState extends State<SentBox> {
  var userData=[];
